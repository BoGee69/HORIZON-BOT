...
OPENDIR_SOURCE_MODE = os.getenv("OPENDIR_SOURCE_MODE", "directory").strip().lower() or "directory"
...
OPENDIR_SHORT_SLEEP_SECONDS = float(os.getenv("OPENDIR_SHORT_SLEEP_SECONDS", "30"))
...
AI_CHAT_R2_DIAGNOSTIC_ENABLED = parse_bool(os.getenv("AI_CHAT_R2_DIAGNOSTIC_ENABLED", "true"), True)
AI_CHAT_R2_DIAGNOSTIC_ON_WHY = parse_bool(os.getenv("AI_CHAT_R2_DIAGNOSTIC_ON_WHY", "true"), True)
AI_CHAT_R2_DIAGNOSTIC_LIMIT = int(os.getenv("AI_CHAT_R2_DIAGNOSTIC_LIMIT", "500"))
AI_CHAT_R2_DIAGNOSTIC_TIMEOUT_SECONDS = float(os.getenv("AI_CHAT_R2_DIAGNOSTIC_TIMEOUT_SECONDS", "25"))
AI_CHAT_R2_DIAGNOSTIC_USE_CACHE = parse_bool(os.getenv("AI_CHAT_R2_DIAGNOSTIC_USE_CACHE", "true"), True)
AI_CHAT_R2_DIAGNOSTIC_LIVE_FALLBACK = parse_bool(os.getenv("AI_CHAT_R2_DIAGNOSTIC_LIVE_FALLBACK", "true"), True)
AI_CHAT_R2_DIAGNOSTIC_LIVE_SCAN_LIMIT = int(os.getenv("AI_CHAT_R2_DIAGNOSTIC_LIVE_SCAN_LIMIT", "1000"))
AI_CHAT_R2_DIAGNOSTIC_TARGET_EXISTS_CHECKS = int(os.getenv("AI_CHAT_R2_DIAGNOSTIC_TARGET_EXISTS_CHECKS", "100"))
...
# AI Security Guardian (alert-only by default).
AI_SECURITY_ENABLED = parse_bool(os.getenv("AI_SECURITY_ENABLED", "true"), True)
AI_SECURITY_ALERT_ONLY = parse_bool(os.getenv("AI_SECURITY_ALERT_ONLY", "true"), True)
AI_SECURITY_AUTO_DELETE_SPAM = parse_bool(os.getenv("AI_SECURITY_AUTO_DELETE_SPAM", "false"), False)
AI_SECURITY_AUTO_TIMEOUT_SPAM = parse_bool(os.getenv("AI_SECURITY_AUTO_TIMEOUT_SPAM", "false"), False)
AI_SECURITY_WINDOW_SECONDS = int(os.getenv("AI_SECURITY_WINDOW_SECONDS", "12"))
AI_SECURITY_MAX_MESSAGES_PER_WINDOW = int(os.getenv("AI_SECURITY_MAX_MESSAGES_PER_WINDOW", "7"))
AI_SECURITY_MAX_MENTIONS_PER_MESSAGE = int(os.getenv("AI_SECURITY_MAX_MENTIONS_PER_MESSAGE", "8"))
AI_SECURITY_MAX_LINKS_PER_WINDOW = int(os.getenv("AI_SECURITY_MAX_LINKS_PER_WINDOW", "4"))
AI_SECURITY_ALERT_COOLDOWN_SECONDS = int(os.getenv("AI_SECURITY_ALERT_COOLDOWN_SECONDS", "180"))
AI_SECURITY_TIMEOUT_SECONDS = int(os.getenv("AI_SECURITY_TIMEOUT_SECONDS", "600"))
...
AI_OPERATOR_ALLOW_OPENDIR_SYNC = parse_bool(os.getenv("AI_OPERATOR_ALLOW_OPENDIR_SYNC", "true"), True)
...
AI_GITHUB_REPO = os.getenv("AI_GITHUB_REPO", os.getenv("AI_CODEX_GITHUB_REPO", GITHUB_REPO)).strip().strip("/")
AI_GITHUB_BASE_BRANCH = os.getenv("AI_GITHUB_BASE_BRANCH", os.getenv("AI_CODEX_BASE_BRANCH", GITHUB_BRANCH)).strip() or "main"
AI_GITHUB_PROVIDER = os.getenv("AI_GITHUB_PROVIDER", os.getenv("AI_CODEX_PROVIDER", AI_CHAT_PROVIDER)).strip().lower() or AI_CHAT_PROVIDER
AI_GITHUB_MODEL = os.getenv("AI_GITHUB_MODEL", os.getenv("AI_CODEX_MODEL", AI_CHAT_MODEL)).strip() or AI_CHAT_MODEL
AI_GITHUB_TEMPERATURE = float(os.getenv("AI_GITHUB_TEMPERATURE", os.getenv("AI_CODEX_TEMPERATURE", "0.15")))
...
AI_GITHUB_TOTAL_CONTEXT_CHARS = int(os.getenv("AI_GITHUB_TOTAL_CONTEXT_CHARS", os.getenv("AI_CODEX_TOTAL_CONTEXT_CHARS", "50000")))
AI_GITHUB_MAX_CHANGED_FILES = int(os.getenv("AI_GITHUB_MAX_CHANGED_FILES", os.getenv("AI_CODEX_MAX_CHANGED_FILES", "4")))
AI_GITHUB_MAX_FILE_BYTES = int(os.getenv("AI_GITHUB_MAX_FILE_BYTES", os.getenv("AI_CODEX_MAX_FILE_BYTES", "70000")))
AI_GITHUB_MAX_GENERATED_FILE_CHARS = int(os.getenv("AI_GITHUB_MAX_GENERATED_FILE_CHARS", os.getenv("AI_CODEX_MAX_GENERATED_FILE_CHARS", "90000")))
AI_GITHUB_TIMEOUT_SECONDS = int(os.getenv("AI_GITHUB_TIMEOUT_SECONDS", os.getenv("AI_CODEX_GITHUB_TIMEOUT_SECONDS", "45")))
AI_GITHUB_ALLOWED_EXTENSIONS = parse_csv_set(
    os.getenv("AI_GITHUB_ALLOWED_EXTENSIONS", os.getenv("AI_CODEX_ALLOWED_EXTENSIONS", "py,md,json,yml,yaml,toml,txt,example,env.example")),
    "py,md,json,yml,yaml,toml,txt,example,env.example",
)

# Compatibility aliases used by existing modules.
AI_CODEX_ENABLED = AI_GITHUB_ENABLED
AI_CODEX_GITHUB_TOKEN = AI_GITHUB_TOKEN
AI_CODEX_GITHUB_REPO = AI_GITHUB_REPO
AI_CODEX_BASE_BRANCH = AI_GITHUB_BASE_BRANCH
AI_CODEX_PROVIDER = AI_GITHUB_PROVIDER
AI_CODEX_MODEL = AI_GITHUB_MODEL
AI_CODEX_TEMPERATURE = AI_GITHUB_TEMPERATURE
AI_CODEX_MAX_OUTPUT_TOKENS = AI_GITHUB_MAX_OUTPUT_TOKENS
AI_CODEX_ALLOW_APPLY = AI_GITHUB_ALLOW_APPLY
AI_CODEX_CREATE_PR = AI_GITHUB_CREATE_PR
AI_CODEX_BRANCH_PREFIX = AI_GITHUB_BRANCH_PREFIX
AI_CODEX_PROPOSAL_TTL_SECONDS = AI_GITHUB_PROPOSAL_TTL_SECONDS
AI_CODEX_MAX_CONTEXT_FILES = AI_GITHUB_MAX_CONTEXT_FILES
AI_CODEX_CONTEXT_CHARS_PER_FILE = AI_GITHUB_CONTEXT_CHARS_PER_FILE
AI_CODEX_TOTAL_CONTEXT_CHARS = AI_GITHUB_TOTAL_CONTEXT_CHARS
AI_CODEX_MAX_CHANGED_FILES = AI_GITHUB_MAX_CHANGED_FILES
AI_CODEX_MAX_FILE_BYTES = AI_GITHUB_MAX_FILE_BYTES
AI_CODEX_MAX_GENERATED_FILE_CHARS = AI_GITHUB_MAX_GENERATED_FILE_CHARS
AI_CODEX_GITHUB_TIMEOUT_SECONDS = AI_GITHUB_TIMEOUT_SECONDS
AI_CODEX_ALLOWED_EXTENSIONS = AI_GITHUB_ALLOWED_EXTENSIONS
