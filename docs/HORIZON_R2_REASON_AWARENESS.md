# HORIZON BOT R2 Reason Awareness Patch
...
HORIZON BOT akan menjelaskan kemungkinan penyebab:
...
Jika ada `last_r2_maintenance_summary`, HORIZON BOT juga akan menampilkan angka skipped, Steam lookup failed, blacklist, error, dan contoh alasan dari run terakhir.
