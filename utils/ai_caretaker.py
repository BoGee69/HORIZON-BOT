...
def build_prompt(snapshot: dict[str, Any]) -> str:
    ...
    return (
        ...
        "• Field roles.*_ids_count berisi jumlah role ID yang dikonfigurasi (integer). "
        "Nilai 1 berarti satu role ID sudah dikonfigurasi dengan benar — ini NORMAL dan VALID. "
        "Jangan flag count=1 sebagai WARNING atau error konfigurasi. "
        "Hanya flag jika *_ids_ok = false atau count = 0 saat moderator_role_required = true.\n"
