...
async def collect_health(bot) -> dict[str, Any]:
    ...
    return {
        ...
        "ai_model_router": {
            "default": bot_config.AI_MODEL_DEFAULT,
            "chat": bot_config.AI_MODEL_CHAT,
            "background_monitor": bot_config.AI_MODEL_BACKGROUND_MONITOR,
            "monitor": bot_config.AI_MODEL_MONITOR,
            "operator": bot_config.AI_MODEL_OPERATOR,
            "r2_maintenance": bot_config.AI_MODEL_R2_MAINTENANCE,
            "intent_router": bot_config.AI_MODEL_INTENT_ROUTER,
            "proposal_manager": bot_config.AI_MODEL_PROPOSAL_MANAGER,
            "code_debugger": bot_config.AI_MODEL_CODE_DEBUGGER,
            "github": bot_config.AI_MODEL_GITHUB,
            "security": bot_config.AI_MODEL_SECURITY,
            "fallback": bot_config.AI_MODEL_FALLBACK,
        },
        "ai_caretaker": {
