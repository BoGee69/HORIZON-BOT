...
async def collect_health(bot) -> dict[str, Any]:
    ...
    return {
        ...
        "database": {
            ...
            "db_path": str(getattr(bot_config, "SQLITE_PATH", bot_config.DATA_DIR / "games.db")),
        },
        "steam_db_sync": {
        ...
        "ai_chat": {
            ...
            "allow_discord_admins": bool(getattr(bot_config, "AI_CHAT_ALLOW_DISCORD_ADMINS", True)),
            ...
            "response_timeout_seconds": bot_config.AI_CHAT_RESPONSE_TIMEOUT_SECONDS,
            ...
            "r2_stats_timeout_seconds": bot_config.AI_CHAT_R2_STATS_TIMEOUT_SECONDS,
            ...
            "server_knowledge_timeout_seconds": bot_config.AI_CHAT_SERVER_KNOWLEDGE_TIMEOUT_SECONDS,
        },
        "ai_operator": {
            "enabled": bool(bot_config.AI_OPERATOR_ENABLED),
            "allowed_ids_configured": bool(bot_config.AI_OPERATOR_ALLOWED_IDS),
            "allow_discord_admins": bool(getattr(bot_config, "AI_OPERATOR_ALLOW_DISCORD_ADMINS", False)),
